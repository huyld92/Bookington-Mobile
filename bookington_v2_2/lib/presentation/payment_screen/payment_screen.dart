                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => Text(
                                    controller.paymentModelObj.value.totalHour,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle.txtManropeBold18,
                                  ),
                          ...
                          Obx(
                            () => ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                SlotModel model = controller.paymentModelObj
                                    .value.listSlotBooking[index];
                                return Padding(
                                  padding: getPadding(
                                    top: 0,
                                  ),
                              ...
                              () => RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                      text:
                                          '${formatCurrency.format(controller.totalAmount.value)} VND',
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding: getPadding(all: 10),
                          child:
                              Text("Total", style: AppStyle.txtManropeBold18),
                        ),
                        Padding(
                          padding: getPadding(all: 10),
                          child: Obx(
                            () => Text(
                                "${formatCurrency.format(controller.total.value)} VND",
                                style: AppStyle.txtManropeBold18),
                          ),
                        ),
                      ],
